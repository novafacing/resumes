...
\begin{flushleft}
	...
	\textbf{Education} \\
	\horizline
	\textbf{Purdue University, West Lafayette IN} \hfill \textbf{December 2020} \\
	...
	\horizline
	\begin{itemize}
			\item Linux, Windows, and MacOS hardening, vulnerability analysis, incident response, forensics \\
			\item C++, C, Java, Python, Lua, Shell scripting, Javascript, Vue.js web development \\
            \item Reverse Engineering, Exploit development, GTK interface development \\
			\item VMWare ESXi Management, Server and network administration, Docker development and deployment \\
			\item IDA Pro, Binary Ninja plugin development, Angr symbolic execution development \\
	\end{itemize}
	\vspace{.25cm}
	\textbf{Relevant Experience}
	\horizline
	\begin{itemize}
        \item \textbf{Purdue University Undergraduate Research Assistant} \hfill \textbf{January 2020 - Present} \\
            \begin{itemize}
		...
		\item \textbf{Purdue University b01lers Capture The Flag Team - Event Coordinator} \hfill \textbf{August 2017 - Present} \\
			\begin{itemize}
                \item Coordinated, developed, and hosted a public CTF competition with over 650 scoring teams \\
				\item Coordinate and create training curriculum development, teaching, and Capture the Flag events to further the skills of team members \\
		...
		\item \textbf{Purdue University CERIAS Collegiate Cyber Defense Competition Team} \hfill \textbf{August 2017 - May 2018} \\
			\begin{itemize}
				\item Wrote automation utilities and harden networks, services, and systems against intrusion using industry-standard security techniques. \\
			\end{itemize}
		\item \textbf{Cyber Patriot Team Captain/Co-Captain}, LCHS Marine Corps JROTC \hfill \textbf{August 2013 - June 2017} \\
			\begin{itemize}
				\item Built challenges and virtual environments using VMWare and shell scripting to engage and mentor team members for hands-on learning in a technically challenging environment \\
				\item Created scripts and tools to streamline system hardening, vulnerability analysis, and malware identification and remediation on Windows and Linux systems \\
			\end{itemize}
	\end{itemize}
	\vspace{.25cm}
